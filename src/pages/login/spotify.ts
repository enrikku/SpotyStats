...
export const GET: APIRoute = async () => {
  ...
  const params = new URLSearchParams({
    ...
    scope: "user-read-currently-playing user-read-private user-read-email user-follow-read user-read-playback-position user-top-read user-read-recently-played user-library-modify user-library-read user-read-playback-state user-modify-playback-state playlist-modify-private playlist-modify-public"  
  });
